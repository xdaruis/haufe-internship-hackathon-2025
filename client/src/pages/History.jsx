  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <ul className="list-disc pl-5 space-y-1 text-sm">
        ...
        <li>
          <Link className="text-indigo-600 hover:underline" to="/new-review">
            New Review
          </Link>
        </li>
        <li>
          <Link className="text-indigo-600 hover:underline" to="/new-model">
            New Model
          </Link>
        </li>
        <li>
          <Link className="text-indigo-600 hover:underline" to="/new-prompt">
            New Prompt
          </Link>
        </li>
      </ul>
      ...
      <form onSubmit={openReview} className="flex items-center gap-2">
        <label htmlFor="rid" className="text-sm">
