...
export default function NewModelPage() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post('/api/code/model/update', { name, model });
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="mx-auto w-full max-w-2xl px-4">
        <div className="mb-6 flex items-center justify-between">
          <h1 className="text-2xl font-semibold text-gray-900">New LLM Model</h1>
        ...
        <form onSubmit={onSubmit} className="space-y-5">
          <div>
            ...
            />
            <p className="mt-1 text-xs text-gray-500">Human-friendly name shown in the UI.</p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="qwen2.5-coder:0.5b"
            />
            <p className="mt-1 text-xs text-gray-500">Exact Ollama tag, e.g. qwen2.5-coder:0.5b.</p>
          </div>
